...
const videoList = [
  ...
  "https://hong-hospital-suwon.s3.ap-northeast-2.amazonaws.com/Kanye+West+-+I+Guess+We'll+Never+Know+(Grammys+Speech).mp4",
  ...
  return (
    <SliderContainer>
      <Slider
        ...
        infinite={true}
        centerMode={true}
        className="facility-slider-thumb"
        arrows={true}
      >
      {
        videoList.map((e)=>{
          return(
            <video className="slider-thumbnail" src={e}/>
          )
        })
      }
      </Slider>
